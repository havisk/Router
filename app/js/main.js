...
var APP_ID = 'whzBDGqQBiuSW1vtdsp9UTNpZbGUUXtni3ohqxsi';
var API_KEY = 'FsBhUUKFQ23Oi2m8aPSX28nSeYOHjqmSv4hvROze';
...
},{"./ajax_Setup":1,"./router":5,"jquery":11,"moment":12,"underscore":13}],5:[function(require,module,exports){
'use strict';
	...
	NewContact: function NewContact() {
		...
		(0, _jquery2['default'])('#submit').click(function () {
			...
			var newAdd = new _contact_model2['default']({
				...
				Phone: Number((0, _jquery2['default'])('#phone').val()),
...
},{"./contact_collection":2,"./contact_model":3,"./views/add":6,"./views/home":7,"./views/list":8,"backbone":9,"jquery":11}],6:[function(require,module,exports){
'use strict';
...
},{"../contact_model":3,"jquery":11}],7:[function(require,module,exports){
'use strict';
